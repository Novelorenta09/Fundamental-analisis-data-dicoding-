...
def create_rfm_df(df):
    rfm_df = df.groupby(by="customer_id", as_index=False).agg({
        "order_date":"max", #mengambil tgl order terakhir
        "order_id": "nunique",  
        "total_price": "sum"
...
# memfilter data all_df dan disimpan di main_df
...
# melengkapi dashboard dengan berbagai visual data
...
# tampilkan 5 produk pling laris dan paling sedikit terjual
...
# tampilkan demografi pelanggan yg dimiliki
...
# tampilkan parameter RFM(recency, frequency, monetary)
# rata-rata dri ke-3 parameter dengan widget metric
...
st.caption("copyright (c) student Dicoding 2026")